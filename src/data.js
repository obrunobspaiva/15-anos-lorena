...
export const BLOCOS = [
  ...
  },
  {
    ...
    atividades: [
      ...
      { h: '20:37', acao: '🎥 Vídeo-Carta — mensagens gravadas por família e amigos (~5–8 min)', resp: 'Operador projetor' },
      { h: '20:45', acao: 'Cerimonialista faz transição emocional — anuncia entrada da Lorena', resp: 'Cerimonialista' },
      { h: '20:47', acao: 'Entrada de Lorena (Look 1) com o pai — violinista toca', resp: 'Lorena / Bruno / Orquestra' },
      { h: '20:52', acao: 'Valsa pai e filha',                                     resp: 'Orquestra' },
      { h: '20:57', acao: 'Fala do cerimonialista — mensagem breve',               resp: 'Cerimonialista' },
      { h: '21:00', acao: '💍 Entrega do Anel — pai → filha, momento simbólico',  resp: 'Bruno / Lorena' },
      { h: '21:05', acao: 'Brinde com família',                                    resp: 'Cerimonialista / Família' },
      { h: '21:10', acao: '🎂 Parabéns — Lorena sopra a vela',                    resp: 'DJ / Todos' },
      { h: '21:15', acao: 'Corte do bolo + fotos',                                resp: 'Família / Fotógrafo' },
      { h: '21:20', acao: 'Mesa de doces liberada',                               resp: 'Equipe buffet' },
      { h: '21:25', acao: '🎆 Fogos indoor — encerramento da cerimônia',          resp: 'Equipe técnica' },
