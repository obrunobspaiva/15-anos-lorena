...
export const BLOCOS = [
  ...
  {
    num: 3, horario: '21:30 – 22:15', duracao: '45min', icone: '🍽️',
    ...
    atividades: [
      ...
      { h: '21:55', acao: 'Lorena sai para troca de look (bastidores) — 20 min',                        resp: 'Maquiadora' },
      { h: '21:55', acao: 'Troca: vestido principal → macaquinho / sapato → tênis / cabelo preso → cabelo solto', resp: 'Maquiadora' },
    ],
  },
  {
    num: 4, horario: '22:15 – 01:00', duracao: '2h45', icone: '💃',
    titulo: 'Balada',
    atividades: [
      { h: '22:15', acao: 'DJ abre a balada — hits, volume subindo',                                    resp: 'DJ' },
      { h: '22:20', acao: 'Luzes apagam — silêncio total',                                              resp: 'Equipe técnica' },
      { h: '22:20', acao: 'Gelo seco + fogos indoor',                                                   resp: 'Equipe técnica' },
      { h: '22:21', acao: 'Entrada Lorena — Look 3 (macaquinho + tênis + cabelo solto)',                 resp: 'Lorena / DJ' },
      { h: '22:22', acao: 'DJ solta hit — Lorena dança livre no centro (~1 min)',                        resp: 'DJ' },
      { h: '22:23', acao: '💃 Amigas surgem — coreografia surpresa com Lorena (~3-4 min)',               resp: 'Amigas / Lorena / DJ' },
      { h: '22:27', acao: '🤖 Robô de LED entra durante a coreografia — CO₂, laser, LEDs sincronizados', resp: 'Robô LED' },
      { h: '22:30', acao: 'Coreografia encerra — DJ solta pancadão — pista aberta pra todos',           resp: 'DJ' },
      { h: '22:30', acao: 'Robô continua interagindo com convidados na pista',                           resp: 'Robô LED' },
      { h: '23:10', acao: 'Robô encerra show (~45 min total)',                                           resp: 'Robô LED' },
      { h: '23:10', acao: 'DJ segue — set de pico até o final da festa',                                 resp: 'DJ' },
    ],
  },
  {
