...
export const BLOCOS = [
  ...
  },
  {
    ...
    atividades: [
      ...
      { h: '21:00', acao: '🎂 Parabéns — Lorena sopra a vela',                    resp: 'DJ / Todos' },
      { h: '21:05', acao: 'Corte do bolo + fotos',                                resp: 'Família / Fotógrafo' },
      { h: '21:10', acao: 'Mesa de doces liberada',                               resp: 'Equipe buffet' },
      { h: '21:15', acao: '🎆 Fogos indoor — encerramento da cerimônia',          resp: 'Equipe técnica' },
      { h: '21:30', acao: 'Transição para o buffet',                              resp: 'Equipe' },
    ],
  },
  {
    num: 3, horario: '21:30 – 22:30', duracao: '1h', icone: '🍽️',
    ...
    atividades: [
      ...
      { h: '22:10', acao: 'Lorena sai para troca de look (bastidores) — ~20 min', resp: 'Maquiadora' },
    ],
  },
  {
    num: 4, horario: '22:30 – 01:00', duracao: '2h30', icone: '💃',
    titulo: 'Balada e Encerramento',
    atividades: [
      { h: '22:30', acao: 'DJ esquenta a pista (hits, volume subindo)',             resp: 'DJ' },
      { h: '22:35', acao: 'Luzes apagam — silêncio total',                        resp: 'Equipe técnica' },
      { h: '22:36', acao: '🤖 Robô de LED entra sozinho — CO₂, laser, aquece a pista (~3 min)', resp: 'Robô LED' },
      { h: '22:39', acao: 'Gelo seco + fogos indoor',                             resp: 'Equipe técnica' },
      { h: '22:39', acao: 'Reentrada de Lorena — Look 2 (macacão de festa)',       resp: 'Lorena / DJ' },
      { h: '22:40', acao: 'DJ solta hit — Lorena dança livre no centro (~1 min)', resp: 'DJ' },
      { h: '22:41', acao: '💃🤖 Amigas surgem + robô — coreografia conjunta (~3–4 min)', resp: 'Amigas / Robô LED / DJ' },
      { h: '22:45', acao: 'Coreografia encerra — DJ solta pancadão — pista aberta pra todos', resp: 'DJ' },
      { h: '22:45', acao: 'Robô continua interagindo com convidados na pista',    resp: 'Robô LED' },
      { h: '23:25', acao: 'Robô encerra show (total ~50 min)',                     resp: 'Robô LED' },
      { h: '23:25', acao: 'DJ segue — set de pico',                               resp: 'DJ' },
      { h: '00:00', acao: 'DJ desacelera gradualmente',                           resp: 'DJ' },
      { h: '00:15', acao: 'Agradecimento de Lorena e família',                    resp: 'Cerimonialista / Lorena' },
      { h: '00:25', acao: 'Última música especial',                               resp: 'DJ' },
      { h: '00:30', acao: 'Cartões QR da galeria digital na mesa de saída',       resp: 'Equipe' },
      { h: '00:40', acao: 'Fotos finais',                                         resp: 'Fotógrafo' },
